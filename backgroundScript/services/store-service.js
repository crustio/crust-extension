...
export const updateHashKeyState = async hashKey =>
  getStore().dispatch(appActions.appStateSetHashKey(hashKey));
...
export const updateCurrentAccountState = async account =>
  getStore().dispatch(accountActions.changeCurrentAccount(account));

export const updateTransactionsState = async transactions =>
  getStore().dispatch(transactionActions.fetchTransactions(transactions));

export const updateCurrentNetworkState = async network =>
...
export const updateWhiteListedDAppsState = async whiteListedDApps =>
  getStore().dispatch(permissionStateActions.updateAuthorizedDAppList(whiteListedDApps));

export const updateAddressBook = addreesBook =>
  getStore().dispatch(updateAddressBookList(addreesBook));
