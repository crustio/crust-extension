...
export const DOT_NETWORK_LIST = [CRUST_MAXWELL_NETWORK, CRUST_NETWORK];

export const DEV_DOT_NETWORK_LIST = [LOCALHOST_NETWORK, CRUST_MAXWELL_NETWORK, CRUST_NETWORK];

const isDev = false;

export const DEFAULT_NETWORK = isDev ? CRUST_DEV_NETWORK : CRUST_MAXWELL_NETWORK;
